...
let timerId = null;
button.addEventListener('click', onButtonStartClick);
...
function onButtonStartClick() {
  ...
  timerId = setInterval(() => {
    ...
    const timeTillFinish = pickedDate - Date.now();
    const { days, hours, minutes, seconds } = convertToMs(timeTillFinish);
